...
# Memory: onchip_mem_2
MEM_0 := JPEG_SoC_onchip_mem_2
$(MEM_0)_NAME := onchip_mem_2
...
$(MEM_0)_HIERARCHICAL_PATH := onchip_mem_2
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: onchip_mem_2
onchip_mem_2: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
